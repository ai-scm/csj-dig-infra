...
export class CSJProdDigitalizacionEstampilladoApiStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const pathBuildSpecBuild = './configuration/csj-prod-digitalizacion-estampillado-api/buildspec_build.yml';
    const pathBuildSpecDeploy = './configuration/csj-prod-digitalizacion-estampillado-api/buildspec_deploy.yml';
    
    const pipelineProps: PipelineConstructProps = {
      namespace: 'CSJProdDigitalizacionEstampilladoApiApp',
      pipelineType: 'fargate',
      ecrRepositoryName: 'csj-prod-digitalizacion-estampillado-api',
      ...
      buildConfig: {
        ...
        environmentVariables: {
          IMAGE_REPO_NAME: { value: 'csj-prod-digitalizacion-estampillado-api' },   // Nombre del repositorio ECR
    ...
    const pipelineConstruct = new PipelineConstruct(this, 'CSJProdDigitalizacionEstampilladoApiAppPipeline', pipelineProps);

    const appName = 'csj-prod-estampillado';
    ...
    const albToFargateProps: AlbToFargateProps = {
      ...
      containerDefinitionProps: {
        ...
        memoryLimitMiB: 8192,  // Memoria asignada al contenedor
        cpu: 2048,  // CPU asignada al contenedor
        portMappings: [{
        ...
        environment: {
          ...
          PDF_BUCKET: 'csj-prod-digitalizacion-datalake',
          PDF_OUT_BUCKET: 'csj-dig-prod-search-engine-875376228721', 
          PDF_OUTPUT_SUFFIX: 'estampilla_out/',
          TZ: 'America/Bogota'
        }
      },
      targetGroupProps: {
      ...
      fargateTaskDefinitionProps: {
        taskRole: taskRole,
        cpu: 2048,  // CPU asignada a la tarea
        memoryLimitMiB: 8192,  // Memoria asignada a la tarea
